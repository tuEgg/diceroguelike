...
function enemy_create(_name, _index, _shadow_scale, _max_hp, _bounty, _moves_array, _move_order, _elite = false, _passive = undefined)
{
    var e = {
        name: _name,
        max_hp: _max_hp,
...
function enemy_definitions() {
	...
	var seagull = enemy_create("Seagull", 2, 0.5, 8, 8, seagull_moves, "pseudo_random");
	...
	var deckhand = enemy_create("Deckhand", 0, 1, 29, 15, deckhand_moves, "pseudo_random");
	...
	var thug = enemy_create("Thug", 1, 1, 36, 17, thug_moves, "pseudo_random");
	...
	var bill = enemy_create("Bill", 0, 1, 20, 17, bill_moves, "pseudo_random", false, passive_heartache);
	...
	var pufferfish = enemy_create("Pufferfish", 0, 1, 36, 17, pufferfish_moves, "weighted");
	...
	var turtle = enemy_create("Turtle", 0, 1, 48, 18, turtle_moves, "pseudo_random", false, passive_turtle_shell);
	...
	var pirate_captain = enemy_create("Pirate Captain", 0, 1, 70, 45, pirate_captain_moves, "weighted", true);
	...
	var titan = enemy_create("Barnacle Titan", 0, 1.5, 125, 151, titan_moves, "pseudo_random");
